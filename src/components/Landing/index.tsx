...
import { Box, Card, Glyph, Text, Title, Header, HeaderGlyph } from "@glif/react-components";
      ...
      >
        ...
        >
          ...
          <Card
            ...
            p={2}
          >
            <a href="https://slate.host" style={{ textDecoration: 'none', color: 'black' }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <a href="mailto:squad@infinitescroll.org" style={{ textDecoration: 'none', color: 'black' }}>
                  <Card
                    display='flex'
                    flexDirection='column'
                    justifyContent='space-between'
